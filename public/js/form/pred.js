    ...
    $.getJSON("index.php/form/get_Pred/" + formulario , function(objRData){
        ...
        if (arrayPred.length > 0){
            ...
            for (var c = arrayPred.length -1; c >=0; c--){
                ...
                tabpred += "<tr><td>" + arrayPred[c].mpo_cod + "</td><td>" + arrayPred[c].mpo + "</td><td>" + arrayPred[c].vereda + "</td><td>" + arrayPred[c].predio + "</td><td>" + arrayPred[c].propietario + "</td><td>" + arrayPred[c].cod_catastral + "</td><td>" + arrayPred[c].fuente + "</td><td>" + arrayPred[c].annio + "</td><td>" + "<a href='" + ruta3 + arrayPred[c].vereda + "&Mp=" + arrayPred[c].mpo + "' target='_blank' class='btn btn-warning'>Ver Ficha Veredal</a>" + "<a href='" + ruta + "' target='_blank' class='btn btn-success'>Geo</a>" + "<a href='" + ruta2 + arrayPred[c].predio + "&Vd=" + arrayPred[c].vereda + "&Mp=" + arrayPred[c].mpo + "' target='_blank' class='btn btn-info'>Ver Ficha Predial</a>" + "</td></tr>";
            }
        }
        else
        {
