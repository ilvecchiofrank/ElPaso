    ...
    $.getJSON("index.php/form/get_Pred/" + formulario , function(objRData){
        ...
        if (arrayPred.length > 0){
            ...
            for (var c = arrayPred.length -1; c >=0; c--){
                ...
                tabpred += "<tr><td>" + arrayPred[c].mpo_cod + "</td><td>" + arrayPred[c].mpo + "</td><td>" + arrayPred[c].vereda + "</td><td>" + arrayPred[c].predio + "</td><td>" + arrayPred[c].propietario + "</td><td>" + arrayPred[c].cod_catastral + "</td><td>" + arrayPred[c].fuente + "</td><td>" + arrayPred[c].annio + "</td><td>" + "<a href='" + ruta + "' target='_blank' class='btn btn-warning'>Ver Ficha Veredal</a>" + "<a href='" + ruta + "' target='_blank' class='btn btn-success'>Geo</a>" + "<a href='" + ruta + "' target='_blank' class='btn btn-info'>Ver ficha predial</a>" + "</td></tr>";
            }
        }
        else
        {
    ...
    $.getJSON("index.php/form/get_Pred_Font/" + formulario, function(objRData){
        ...
        if (arrayPredFont.length > 0) {
            ...
            for (var i = arrayPredFont.length - 1; i >= 0; i--) {
                var ruta = "http://localhost/pmapper/map_default.phtml";
                tabfont += "<tr><td>" + arrayPredFont[i].FECHA_EXPEDICION + "</td><td>" + arrayPredFont[i].CARGO + "</td><td>" + arrayPredFont[i].FECHA_INICIO + "</td><td>" + arrayPredFont[i].FECHA_FIN + "</td><td>" + arrayPredFont[i].TIPO_PERSONA_JURIDICA + "</td><td>" + arrayPredFont[i].NOMBRE_PERSONA_JURIDICA  + "</td><td>" + arrayPredFont[i].DOC_IDENTIFICACION + "</td><td>" + arrayPredFont[i].NIT_PERSONA_JURIDICA + "</td><td>" + arrayPredFont[i].NOMBRE_EMPRESA + "</td><td>" + arrayPredFont[i].NIT_EMPRESA + "</td><td>" + arrayPredFont[i].DESCRIP_RELACION + "</td><td>" + arrayPredFont[i].VALORES_CERTIFICADOS  + "</td><td>" + arrayPredFont[i].UNIDADES + "</td><td>" + arrayPredFont[i].CANTIDAD + "</td><td>" + arrayPredFont[i].DESCRIP_UNIDADES + "</td><td>" + arrayPredFont[i].DIRECCION_CERTIFICACION + "</td><td>" + arrayPredFont[i].ZONA + "</td><td>" + arrayPredFont[i].BARRIO + "</td><td>" + arrayPredFont[i].TIPO_CERTIFICACION + "</td><td>" + arrayPredFont[i].OTRA_DESCRIP_UNIDADES + "</td><td>" + arrayPredFont[i].PERSONA_FIGURA + "</td><td>" + arrayPredFont[i].NOMBRE_PERSONA_FIRMA + "</td><td>" + arrayPredFont[i].CARGO_PERSONA_FIRMA + "</td><td>" + arrayPredFont[i].OBSERVACIONES + "</td><td>" + arrayPredFont[i].MUNICIPIO + "</td><td>" + arrayPredFont[i].VEREDA + "</td><td>" + arrayPredFont[i].PREDIO + "</td><td>" + arrayPredFont[i].OTRO_MUNICIPIO + "</td><td>" + arrayPredFont[i].OTRA_VEREDA + "</td><td>" + arrayPredFont[i].OTRO_PREDIO + "</td><td>" + arrayPredFont[i].COD_CATASTRAL + "</td><td>" + "<a href='" + ruta + "' target='_blank' class='btn btn-warning'>Ver Ficha Veredal</a>" + "<a href='" + ruta + "' target='_blank' class='btn btn-success'>Geo</a>" + "<a href='" + ruta + "' target='_blank' class='btn btn-info'>Ver ficha predial</a>" + "</td></tr>";
            };
