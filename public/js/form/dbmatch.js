...
function loadBovinaICA() {
    ...
    $.getJSON("index.php/form/get_BovinaICA/" + cedula, function(objRData) {
        ...
        if (arrayBovina.length >= 1) {
            tablabovina += "<table border='1' cellpadding='0' cellspacing='0' style='width: 95%;'><tbody><tr><td>Num</td><td>No Guía</td><td>Fecha</td><td>Autoriza a</td><td>C.C.</td><td>Finca Origen</td><td>Propietario Finca</td><td>Mun Finca Orig</td><td>Dpto Finca Orig</td><td>Finca Destino</td><td>Prop. Finca Destino</td><td>Mun. Finca Destino</td><td>Depto. Finca Destino</td><td>Especie</td><td>Total Animales</td><td>Placa Vehiculo</td><td>Empresa</td><td>Ruta</td><td>Conductor</td></tr>";
            for (var e = arrayBovina.length - 1; e >= 0; e--) {
                tablabovina += "<tr><td>" + arrayBovina[e].num + "</td><td>" + arrayBovina[e].no_guia + "</td><td>" + arrayBovina[e].fecha + "</td><td>" + arrayBovina[e].autoriza_a + "</td><td>" + arrayBovina[e].cc + "</td><td>" + arrayBovina[e].finca_origen + "</td><td>" + arrayBovina[e].propietario_finca_orig + "</td><td>" + arrayBovina[e].mun_finca_orig + "</td><td>" + arrayBovina[e].dpto_finca_orig + "</td><td>" + arrayBovina[e].finca_destino + "</td><td>" + arrayBovina[e].propietario_finca_dest + "</td><td>" + arrayBovina[e].mun_finca_dest + "</td><td>" + arrayBovina[e].depto_finca_dest + "</td><td>" + arrayBovina[e].especie + "</td><td>" + arrayBovina[e].total_animales + "</td><td>" + arrayBovina[e].placa_vehiculo + "</td><td>" + arrayBovina[e].empresa + "</td><td>" + arrayBovina[e].ruta + "</td><td>" + arrayBovina[e].conductor + "</td></tr>";
            }
        } else {
