...
<page backtop="25mm" backbottom="25mm" style="font-size: 10pt;">
    ...
    <page_footer style="text-align: center; color: #878787; font-weight: bold; font-size: 8pt;"> 

        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
            <tbody>
                <tr>
                    <td style="width: 90%;">Oficina Bogotá: Cra 11 # 82 – 76 Piso 4 – Bogotá, Colombia –  (571) 219 0330</td>
                    <td rowspan="4"><img src="public/img/VoBo.png"></td>
                </tr>
                <tr>
...
<!--                        <td style='width:50%; text-align: right;'><img alt="Emgesa" src="public/img/logoprint.gif" class="img-responsive" style="float: right;"></td>-->
                ...
                <p>
                    Es para nosotros grato informar a Usted que en el proceso censal ordenado por la H. Corte Constitucional en el marco de la sentencia T-135/13, le correspondió el No. <?php echo $arrPrintData[0]->formulario; ?>
